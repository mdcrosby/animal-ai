...
# tensorboard --logdir ppo_tensorboard_MOVINGBALL_train
...
def train_agent_single_config(configuration_file):
    ...
    model = PPO("CnnPolicy", env, policy_kwargs=policy_kwargs, tensorboard_log=("./ppo_tensorboard_MOVINGBALL_train/" + runname), verbose=1) 

    no_saves = 10
    no_steps = 250000
    reset_num_timesteps = False

    results_path = "results_MMB_ppo"
